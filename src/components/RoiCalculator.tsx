...
export default function RoiCalculator() {
  ...
  return (
    <section id="calculator" className="relative py-24 bg-[#0a0c0a] overflow-hidden">
      
      {/* Decorative vectors */}
      <div className="absolute top-1/3 left-1/10 w-96 h-96 bg-w2e-green/2 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 font-sans">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="h-1 w-16 bg-w2e-lime mx-auto mt-4 mb-4 rounded-full" />
        ...
        <div className="flex justify-end gap-2 mb-6">
          <button
            ...
            className={`px-3 py-1 text-[10px] font-mono tracking-wider font-bold rounded-md transition-colors cursor-pointer ${
              currency === "INR" ? "bg-w2e-lime text-black" : "bg-white/5 text-gray-400 hover:text-white"
            }`}
          >
            INR (₹)
          </button>
          <button
            ...
            className={`px-3 py-1 text-[10px] font-mono tracking-wider font-bold rounded-md transition-colors cursor-pointer ${
              currency === "USD" ? "bg-w2e-lime text-black" : "bg-white/5 text-gray-400 hover:text-white"
            }`}
          >
            USD ($)
          </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden glow-green">
          
          {/* LEFT: Inputs Panel (5 Cols) */}
          <div className="lg:col-span-6 p-6 sm:p-10 border-r border-white/10 space-y-8">
            <div className="flex items-center gap-2 pb-4 border-b border-white/10 font-heading">
              <Calculator className="w-5 h-5 text-[#8CC63F]" />
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-[#0a0c0a] border border-white/15 hover:border-[#8CC63F]/50 focus:border-[#8CC63F] rounded-lg px-4 py-3 text-xs text-white focus:outline-hidden transition-colors"
              >
            ...
            <div>
              <div className="flex justify-between items-center mb-3 font-mono text-xs">
                ...
                <span className="text-w2e-lime font-bold text-sm bg-w2e-green/10 px-2 py-0.5 rounded-sm border border-w2e-green/20">
              ...
              <input
                ...
                className="w-full h-1.5 bg-white/10 accent-w2e-lime rounded-md cursor-pointer"
              />
          ...
          <div className="lg:col-span-6 p-6 sm:p-10 bg-radial from-w2e-green/10 via-transparent to-transparent flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 pb-4 border-b border-white/5 mb-8">
                <Sparkles className="w-5 h-5 text-w2e-lime animate-spin" />
                <h3 className="font-heading font-extrabold text-base text-white tracking-widest uppercase">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="bg-black/35 border border-white/5 p-4 rounded-xl">
                  <Flame className="w-4 h-4 text-w2e-lime mb-1" />
                ...
                <div className="bg-black/35 border border-white/5 p-4 rounded-xl">
                  ...
                  <span className="block font-mono text-xl font-bold text-[#8CC63F]">{formatMoney(outputs.annualRevenue)}</span>
            ...
            <div className="mt-8 border-t border-white/5 pt-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                <span className="block text-[10px] font-mono text-gray-400 uppercase tracking-widest mb-1 flex items-center gap-1">
                  PAYBACK PERIOD
                  <Info className="w-3.5 h-3.5 text-w2e-lime animate-pulse cursor-help" title="Calculated using standardized EBITDA averages." />
                </span>
                <span className="block text-3xl font-mono font-black text-w2e-lime">
