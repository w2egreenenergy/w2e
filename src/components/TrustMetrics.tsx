...
export default function TrustMetrics() {
  ...
  return (
    <section id="metrics" className="relative py-20 bg-[#121817]/60 backdrop-blur-xl border-y border-[#00C853]/10 overflow-hidden">
      ...
      <div className="absolute right-0 top-0 w-80 h-80 bg-[#00C853]/6 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute left-0 bottom-0 w-80 h-80 bg-[#3DDC84]/6 rounded-full blur-[100px] pointer-events-none" />
